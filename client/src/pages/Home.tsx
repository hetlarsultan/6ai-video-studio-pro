...
import { Loader2, Film, Image, Wand2, Volume2, AlertCircle, CheckCircle2 } from 'lucide-react';

/**
 * Design Philosophy: Modern Creative Studio
...
export default function Home() {
  ...
  const handleImagesToGif = async () => {
    ...
    try {
      ...
      const gif = new (GIF as any)({ workers: 2, quality: 10 });
      let loaded = 0;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 text-white p-4 md:p-8">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card className="bg-slate-800/50 border-slate-700 p-6 hover:border-cyan-500/50 transition-colors">
          ...
          >
            ...
            {loading ? 'جاري المعالجة...' : 'إنشاء فيديو'}
          </Button>
          {videoOutputRef && (
            <video
              ref={videoOutputRef}
        ...
        <Card className="bg-slate-800/50 border-slate-700 p-6 hover:border-cyan-500/50 transition-colors">
          ...
          >
            ...
            {loading ? 'جاري المعالجة...' : 'إنشاء GIF'}
          </Button>
          {gifOutputRef && (
            <img
              ref={gifOutputRef}
      ...
      <div className="max-w-7xl mx-auto mt-12 text-center text-slate-400 text-sm">
        <p>جميع المعالجات تتم محليًا في المتصفح - لا توجد تحميلات على الخادم</p>
      </div>
    </div>
  );
}
